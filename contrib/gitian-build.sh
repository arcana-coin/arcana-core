...
VERSION=
commit=false
url=https://github.com/arcana-coin/arcana-core
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/arcana-coin/arcana-core
...
then
    ...
    git clone https://github.com/arcana-core/gitian.sigs.git
    git clone https://github.com/arcana-core/bitcoin-detached-sigs.git
