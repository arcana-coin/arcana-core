...
* bitcoin.conf: contains configuration settings for arcanad or arcana-qt
* arcanad.pid: stores the process id of arcanad while running
...
* debug.log: contains debug information and general logging generated by arcanad or arcana-qt
