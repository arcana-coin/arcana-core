...
#ifndef ARCANA_TEST_SCRIPTNUM10_H
#define ARCANA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Arcana Core 0.10.0, for cross-comparison.
 */
public:
