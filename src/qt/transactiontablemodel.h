...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ArcanaUnits::SeparatorStyle separators=ArcanaUnits::separatorStandard) const;
...
#endif // ARCANA_QT_TRANSACTIONTABLEMODEL_H
