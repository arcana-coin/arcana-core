...
const QString ARCANA_IPC_PREFIX("bitcoin:");
...
void PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(ARCANA_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
        {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(ARCANA_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
