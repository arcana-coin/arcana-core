...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ArcanaAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_arcana-qt -platform xcb      # Linux
//     src/qt/test/test_arcana-qt -platform windows  # Windows
//     src/qt/test/test_arcana-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    // Amount input
    ArcanaAmountField* amountInput = receiveCoinsDialog.findChild<ArcanaAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: arcana:")) != -1);
