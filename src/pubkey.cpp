// Copyright (c) 2009-2017 The Arcana Core developers
 ...
 *  Arcana because since the activation of BIP66, signatures are verified to be
...
bool CPubKey::Verify(const uint256 &hash, const std::vector<unsigned char>& vchSig) const {
     ...
     * not historically been enforced in Arcana, so normalize them first. */
